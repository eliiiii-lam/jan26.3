...
@Autonomous (name = "BLUE SHORT SCORE")
public class blueshortscore extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        encoderDrive(DRIVE_SPEED, 46, 46,  1.5);
    ...
    public void elbowmove(double speed,
        ...
        if (opModeIsActive()) {
            ...
            while (opModeIsActive() &&
                ...
                // Display it for the driver.
                telemetry.addData("Running to", " %7d :%7d", newElbow);
                telemetry.addData("Currently at", " at %7d :%7d",
