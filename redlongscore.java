...
@Autonomous (name = "RED LONG SCORE")
public class redlongscore extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        encoderDrive(DRIVE_SPEED, 52, 52, 1.5);
        ...
        encoderDrive(DRIVE_SPEED,76, 76, 1.5);

        //strafe LEFT


        strafeRight(DRIVE_SPEED, -33, -33, -33, -33, 1.5);

        encoderDrive(DRIVE_SPEED, 23.5, 23.5, 1.5);
        ...
        elbowmove(DRIVE_SPEED,-30,3);
        encoderDrive(DRIVE_SPEED,3,3,1.5);



        strafeLeft(DRIVE_SPEED,24,24,24,24,1.5);
